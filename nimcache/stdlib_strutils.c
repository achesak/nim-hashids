...
/* Command for C compiler:
   gcc -c  -w  -I/home/adam/.choosenim/toolchains/nim-0.18.0/lib -o /home/adam/Documents/Projects/nim-hashids/nimcache/stdlib_strutils.o /home/adam/Documents/Projects/nim-hashids/nimcache/stdlib_strutils.c */
...
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_15, "0123456789ABCDEF", 16);
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_16, "\0120 < len(sep) ", 14);
...
N_LIB_PRIVATE N_NOINLINE(void, invalidFormatString_61EJWW6vRISEo9a8gt0tusw)(void) {
	...
	T1_ = (NimStringDesc*)0;
	T1_ = (*e).Sup.message; (*e).Sup.message = copyStringRC1(((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_13));
...
N_LIB_PRIVATE N_NIMCALL(NIM_CHAR, nsuToLowerAsciiChar)(NIM_CHAR c) {
	...
	nimln_(207, "strutils.nim");
	{
		...
		TM_JGc9b9bh2D3nTdUR7TGyq8aA_14 = addInt(((NU8)(c)), ((NI) 32));
		result = ((NIM_CHAR) (((NI)chckRange((NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_14), ((NI) 0), ((NI) 255)))));
	}
	goto LA1_;
	LA3_: ;
	{
	...
	result = mnewString(((NI) (len)));
	{
		...
		res = colontmp_;
		{
			while (1) {
				...
				j = res;
				result->data[j] = ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_15)->data[(NI64)(n & IL64(15))];
...
N_LIB_PRIVATE N_NIMCALL(tySequence_sM4lkSb7zS6F7OVMvW9cffQ*, nsuSplitString)(NimStringDesc* s, NimStringDesc* sep, NI maxsplit) {
	...
	result = (tySequence_sM4lkSb7zS6F7OVMvW9cffQ*)0;
	{
		...
		raiseAssert_PpfSiTIeNpMAb9a5o6SglJw_2(((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_16));
	}
	LA3_: ;
